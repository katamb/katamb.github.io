...
function obfuscatedSort(){var adgjihgrgahgarhues=document.getElementById("input").value;{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}
adgjihgrgahgarhues=adgjihgrgahgarhues.split(",");var gjhdksonfuinevinsesinvspn=[];{{{{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}}}}
var fdkanhbinmffnbdfjugnh;var dngsuigsuigusdig=3;var hgjsdfglhgl=0;var gkihnssng=1;var gfdshdgsjh=false;{{{{{{{{}}}}}}}}
var hghhjfyjf=true;for(var kfmgknlknsd=hgjsdfglhgl;kfmgknlknsd<adgjihgrgahgarhues.length; kfmgknlknsd++){{{{{{{{;}}}}}}}
